export default {
    apiUsers: 'http://192.168.0.17:5000/api/users/',
    apiStocks: 'http://192.168.0.17:5000/api/stocks/',
    apiParameter: 'http://192.168.0.17:5000/api/parameter/',
    apiHistory: 'http://192.168.0.17:5000/api/stocks/history/',
    ...
    navBackColor: 'navbar-blue', // navbar-default, (navbar-blue, navbar-red, navbar-purple, navbar-lightblue, navbar-dark are not available in lite version)
    navBrandColor: 'brand-blue', // brand-default, (brand-blue, brand-red, brand-purple, brand-lightblue, brand-dark are not available in lite version)
    ...
    navActiveListColor: 'active-blue', // active-default, (active-blue, active-red, active-purple, active-lightblue, active-dark are not available in lite version)
    navListTitleColor: 'title-blue', // title-default, (title-blue, title-red, title-purple, title-lightblue, title-dark are not available in lite version)
